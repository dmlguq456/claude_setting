...
- **`--qa quick/light/standard/thorough/adversarial`** — 리뷰 강도. **단일 정의는 [`QA_LEVELS.md`](QA_LEVELS.md)에 있음** (5단계 reviewer 구성·fact-checker 적용 여부·skill별 max level 매트릭스). 본 줄은 요약:
