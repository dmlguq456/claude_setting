...
| 번역팀 (translation-team) | opus | 한국어 산출물 전담 — 영문 → 국문 옮기기 (모드 A) / 이미 한국어인 문서 다듬기 (모드 B) / 점검만 (모드 C). 판교체 회피 강제. | init-plan / init-doc-strategy 의 Korean Version Generation, autopilot-doc Step 4-KO | "한국어 다듬어줘" / "판교체 정리" / "국문 가독성 점검" |
