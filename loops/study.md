...
3. **현 세팅 대조**: `<agent-home>/CORE.md`·runtime adapter bootstrap(현재 Claude Code: `CLAUDE.md`)·`CONVENTIONS.md`(특히 §5.8~5.10)·`loops/README.md`·`hooks/` 목록을 Read 하고, 조사 결과와 비교 — 우리가 이미 하는 것 / 빠진 것 / 더 잘하는 것 구분.
