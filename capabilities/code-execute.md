...
The historical Claude Skill compatibility reference remains at `skills/code-execute/SKILL.md`; Claude Code consumes `adapters/claude/skills/code-execute/SKILL.md` as the adapter-native realization while portable meaning moves here.
