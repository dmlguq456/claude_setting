...
The historical Claude Skill compatibility reference remains at `skills/autopilot-lab/SKILL.md`; Claude Code consumes `adapters/claude/skills/autopilot-lab/SKILL.md` as the adapter-native realization while portable meaning moves here.
