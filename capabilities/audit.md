...
The historical Claude Skill compatibility reference remains at `skills/audit/SKILL.md`; Claude Code consumes `adapters/claude/skills/audit/SKILL.md` as the adapter-native realization while portable meaning moves here.
