...
description: Analyze codebase and generate structured documentation in .claude_reports/docs/
argument-hint: "[target directory or scope]"
---

## Language Rule
- Think and reason in English internally.
- Write documentation files (.claude_reports/docs/) in English.
...
Write analysis results as topic-separated md files in .claude_reports/docs/.
...
- .claude_reports/docs/ document list with coverage table
...
- Check that every code file in models/ and utils/ is covered by at least one .claude_reports/docs/ document.
