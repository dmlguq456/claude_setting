...
`.agent_reports/research/agent-engineering-principles/` (autopilot-research --mode technology, 2026-06-11)
...
2. 산출물 기반 소통 원칙 강조 — 1부 P8 정식 등재 + 2부 한 줄기 매핑 (`.agent_reports`=통신 버스 → 핸드오프 → pipeline_state 재개 → 3-tier → headless 분사 → worklog 2-layer)
...
8. 산출물 이관 — 완료 후 research 폴더 + documents 산출물을 `~/.claude/.agent_reports/research/` 로 이관
